    ...
    public class Tests
    {
      ...
      [TestCase(null, null)]
        ...
        public void ShouldSerializeAndDeserializeComplexDataStructures(string member1, string member2)
        {
            ...
            var deserializeObject = JsonConvert.DeserializeObject<ObjectWithMaybeReferenceType>(serializedObject) ?? throw new Exception();
        ...
        {
            var deserializeObject = JsonConvert.DeserializeObject<ObjectWithMaybePrimitiveType>(jsonWithNullPrimitive) ?? throw new Exception();
        ...
        {
            var deserializeObject = JsonConvert.DeserializeObject<ObjectWithMaybePrimitiveType>("{\"AnInteger\":2}") ?? throw new Exception();
